/*
	...
	compile: g++ -O3 src/dimerNVE.cpp -o dgel.o
	./dgel.o 32 0.1 2 1 1 0.05 1e-12 1 pos.test
...
int main(int argc, char const *argv[])
{
  ...
  //               }
		...
		if (it % 100 == 0){
			K = 0.0;
			for (i=0; i<NMTOT; i++)
				K += 0.5*mass[i]*(v[NDIM*i]*v[NDIM*i] + v[NDIM*i + 1]*v[NDIM*i + 1] + v[NDIM*i + 2]*v[NDIM*i + 2]);
	...
	cout << "	** FINISHED MAIN FOR dimerGel.cpp, ENDING." << endl << endl << endl;
	return 0;
}
